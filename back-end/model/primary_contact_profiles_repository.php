...
class PrimaryContactProfilesRepository {
    ...
    public static function getPrimaryContactProfiles() {
        ...
        foreach ($result as $row) {
            $primaryContactProfile = new PrimaryContactProfiles($row['id'], $row['relationship'], $row['first_name'], 
                    $row['last_name'], $row['chinese_name'], $row['age'], $row['language_spoken'], $row['occupation'],
                    $row['employer'], $row['primary_email'], $row['additional_email'], $row['cell_phone_number'], $row['work_phone_number'],
                    $row['note']);
